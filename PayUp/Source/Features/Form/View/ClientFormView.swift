...
final class ClientFormView: UIView {
    ...
    private let recurringLabel: UILabel = {
        let label = UILabel()
        label.text = "Cobranças recorrentes"
        label.font = Fonts.titleSmall()
    ...
    private lazy var clientNameField = InputTextField(title: "Nome do cliente", placeholder: "Ex: João da Silva", type: .normal)
    private lazy var contactField = InputTextField(title: "Contato", placeholder: "Ex: joao@gmail.com", type: .normal)
    private lazy var phoneField = InputTextField(title: "Telefone", placeholder: "(31) 91234-5678", type: .cellphone)
    private lazy var cnpjField = InputTextField(title: "CNPJ", placeholder: "Ex: 12.345.678/0001-99", type: .cnpj)
    private lazy var addressField = InputTextField(title: "Endereço", placeholder: "Ex: Rua das Flores, 123, Centro", type: .normal)
    ...
    private func setupActions() {
        recurringSwitch.addTarget(self, action: #selector(recuringToggled), for: .valueChanged)
    ...
    private func frequencyTapped() {
        let alert = UIAlertController(title: "Frequência", message: "Selecione a frequencia de conbranças", preferredStyle: .actionSheet)
    ...
    private func populateFieldForEditMode() {
