...
final class CompanyListView: UIView {
   ...
   init(companies: [CompanyItemModel]) {
        self.viewModel = CompanyViewModel(componies: companies)
...
extension CompanyListView: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return viewModel.componies.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configure(with: viewModel.componies[indexPath.item])
        return cell
    }
}
...
extension CompanyListView: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let selectedCompany = viewModel.componies[indexPath.item]
